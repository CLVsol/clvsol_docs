...
This project will help you create a server to host the **CLVhealth-Pharm** solution, based on an `Odoo 10 <https://www.odoo.com/>`_  appliance, using the VMWare Workstagion infrastructure.
...
#. Create a new Virtual Machine using the following parameters:
	...
	- Set a VM Name and a VM Location of your preference (**tkl-odoo10-pharm-vm** - **D:\\vm\\tkl-odoo10-pharm-vm**).
...
#. (Optional) Reboot the instance "**tkl-odoo10-pharm-vm**".
...
#. To access remotly the server, use the following commands (as **openerp**):
	...
	::
		...
		cd /opt/openerp/clvsol_clvhealth_pharm/data
		python setup.py -h
...
#. To install "**clvsol_odoo_addons_l10n_br**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp/clvsol_odoo_addons_pharm
		git branch -a
...
`clvsol_odoo_addons_pharm <https://github.com/CLVsol/clvsol_odoo_addons_pharm>`_
--------------------------------------------------------------------------------

Tools for Odoo Administrators to improve some technical features on Odoo. 

#. To install "**clvsol_odoo_addons_pharm**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp
		git clone https://github.com/CLVsol/clvsol_odoo_addons_pharm --branch 10.0
		cd /opt/openerp/clvsol_odoo_addons_pharm
		git branch -a
...
#. Edit the files "**/etc/odoo/openerp-server.conf**" and "**/etc/odoo/openerp-server-man.conf**":
	...
	::
			...
			# addons_path = /opt/openerp/odoo/addons,...
			addons_path = /opt/openerp/odoo/addons,...,/opt/openerp/clvsol_odoo_addons_pharm


`clvsol_clvhealth_pharm <https://github.com/CLVsol/clvsol_clvhealth_pharm>`_
-----------------------------------------------------------------------------

Tools for Odoo Administrators to improve some technical features on Odoo. 

#. To install "**clvsol_clvhealth_pharm**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp
		git clone https://github.com/CLVsol/clvsol_clvhealth_pharm --branch 10.0
		cd /opt/openerp/clvsol_clvhealth_pharm
		git branch -a
