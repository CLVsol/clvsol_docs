...
#. Create a new Key Pair:
	...
	* Key pair name: **clvheatlh-jcafb-2019-aws-tst**
	* Private Key File: **clvheatlh-jcafb-2019-aws-tst.pem**
...
#. Create an Amazon EC2 instance:
		...
		- Security group name: **clvheatlh-jcafb-2019-aws-tst**
		- SSH key-pair: **clvheatlh-jcafb-2019-aws-tst**

	Related information:

		- Private Key File: **clvheatlh-jcafb-2019-aws-tst.pem**

	Security Group: **clvheatlh-jcafb-2019-aws-tst** (Inbound)::
...
#. Update host name, executing the following commands:
	...
	::
		...
		HOSTNAME=clvheatlh-jcafb-2019-aws-tst
