...
This project will help you create a server to host the **CLVhealthj-JCAFB** solution, based on an `Odoo 9 <https://www.odoo.com/>`_  appliance, using the VMWare Workstagion infrastructure.
...
#. Create a new Virtual Machine using the following parameters:
	...
	- Set a VM Name and a VM Location of your preference (**tkl-odoo09-jcafb-vm** - **D:\\vm\\tkl-odoo09-jcafb-vm**).
...
#. (Optional) Reboot the instance "**tkl-odoo09-jcafb-vm**".
...
#. To access remotly the server, use the following commands (as **root**):
	...
	::
		...
		ssh tkl-odoo09-jcafb-vm -l root
...
#. To access remotly the server, use the following commands (as **openerp**):
	...
	::
		...
		ssh tkl-odoo09-jcafb-vm -l openerp
...
`mostlyopen_odoo_addons <https://github.com/MostlyOpen/odoo_addons>`_
---------------------------------------------------------------------

Tools for Odoo Administrators to improve some technical features on Odoo. 

#. To install "**mostlyopen_odoo_addons**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp
		git clone https://github.com/MostlyOpen/odoo_addons mostlyopen_odoo_addons --branch master --depth=1
...
`mostlyopen_odoo_addons_jcafb <https://github.com/MostlyOpen/odoo_addons_jcafb>`_
---------------------------------------------------------------------------------

Tools for Odoo Administrators to improve some technical features on Odoo. 

#. To install "**mostlyopen_odoo_addons_jcafb**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp
		git clone https://github.com/MostlyOpen/odoo_addons_jcafb mostlyopen_odoo_addons_jcafb --branch master --depth=1
...
#. Edit the files "**/etc/odoo/openerp-server.conf**" and "**/etc/odoo/openerp-server-man.conf**":
	...
	::
			...
			# addons_path = /opt/openerp/odoo/addons,...
			addons_path = /opt/openerp/odoo/addons,...,/opt/openerp/mostlyopen_odoo_addons_jcafb


`mostlyopen_clvhealth_jcafb <https://github.com/MostlyOpen/clvhealth_jcafb>`_
-----------------------------------------------------------------------------

Tools for Odoo Administrators to improve some technical features on Odoo. 

#. To install "**mostlyopen_clvhealth_jcafb**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp
		git clone https://github.com/MostlyOpen/clvhealth_jcafb mostlyopen_clvhealth_jcafb --branch master --depth=1
		cd /opt/openerp/mostlyopen_clvhealth_jcafb
		git branch -a


`mostlyopen_odoo_api <https://github.com/MostlyOpen/odoo_api>`_
---------------------------------------------------------------

Tools for Odoo Administrators to improve some technical features on Odoo. 

#. To install "**mostlyopen_odoo_apis**", use the following commands (as openerp):
	...
	::
		...
		cd /opt/openerp
		git clone https://github.com/MostlyOpen/odoo_api mostlyopen_odoo_api --depth=1
		cd /opt/openerp/mostlyopen_odoo_api
		git branch -a
...
#. To create a symbolic link "odoo_api", use the following commands (as **root**):
	...
	::
		...
		ln -s /opt/openerp/mostlyopen_odoo_api odoo_api 
