...
#. Create a new Virtual Machine using the following parameters:
	...
	- Set a VM Name and a VM Location of your preference (**clvhealth-jcafb-2018-vm** - **D:\\vm\\clvhealth-jcafb-2018-vm**).
...
#. Update host name, executing the following commands:
	...
	::
		...
		HOSTNAME=clvhealth-jcafb-2018-vm
...
#. (Optional) Reboot the instance "**clvhealth-jcafb-2018-vm**".
