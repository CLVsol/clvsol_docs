...
#. Create a new Key Pair:
	...
	* Key pair name: **tkl-odoo10-biobox-aws**
	* Private Key File: **tkl-odoo10-biobox-aws.pem**
...
#. Create an Amazon EC2 instance:
		...
		- Security group name: **tkl-odoo10-biobox-aws**
		- SSH key-pair: **tkl-odoo10-biobox-aws**

	Related information:

		- Private Key File: **tkl-odoo10-biobox-aws.pem**

	Security Group: **tkl-odoo10-biobox-aws** (Inbound)::
...
#. Credentials (passwords set at first boot), via o *SecureCRT*, executando:

	- Webmin, SSH: username **admin**
	- PostgreSQL, Adminer: username **postgres**
	- Odoo Master Account: **admin**

#. Enhable login as **root** instead of **admin** (`TurnKey GNU/Linux on the AWS marketplace <https://www.turnkeylinux.org/awsmp>`_), via o *SecureCRT*:
...
#. Update host name, executing the following commands:
	...
	::
		...
		HOSTNAME=tkl-odoo10-biobox-aws
...
#. To access remotly the server, use the following commands (as **root**):
	...
	::
		...
		ssh tkl-odoo10-biobox-aws -l root
...
#. To access remotly the server, use the following commands (as **openerp**):
	...
	::
		...
		ssh tkl-odoo10-biobox-aws -l openerp
...
#. To install "**clvsol_clvhealth_biobox**", use the following commands (as openerp):
