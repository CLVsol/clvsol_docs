...
#. Install TeamViewer 13:
	...
	First download the TeamViewer from `here <http://www.teamviewer.com/hi/download/linux.aspx>`_
	...
	In the same directory you downloade the .deb file just run:
		...
		::
			...
			cd ~/Downloads
			sudo gdebi teamviewer_13.2.13582_amd64.deb


	It will list the dependencies and install it with a y.

		* dpkg: warning: unable to delete old directory '/var/log/teamviewer12': Directory not empty
		* TeamViewer 12 was uninstalled and replaced by TeamViewer 13.
