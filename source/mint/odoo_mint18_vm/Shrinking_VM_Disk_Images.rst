...
#. **Preparation of the VM**
	...
	#. Set the delay in the .vmx file for the virtual machine::
		...
		# This is 5000 ms, or 5 seconds. Set to taste. 
		# Now you will get a delay when you start the VM.

	#. On the main vm toolbar after opening the VM and BEFORE powering it on choose VM -> Power -> Power On to BIOS. That works for the NEXT ONE boot::
...
#. **Wiping Free Space**
	...
	Guarantee we're done and shut down (skip this)::
