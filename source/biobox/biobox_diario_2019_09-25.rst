...
#. Converter os arquivos de Consumo via Orizon do formato **.xls** para **.csv** usando o *Gnumeric Portable*:
    ...
    #. Editar o *Name* do arquivo de ***.txt** para ***.csv** > **Save** > **Yes** > **Save**:
        * Export Formating:
            ...
            * Format: Auto
        * Lista de Arquivos:
            * 1865_Desconto_em_Folha_Analitico_2019-09-01_ate_2019-09-20.csv
            * 1898_Desconto_em_Folha_Analitico_2019-09-01_ate_2019-09-20.csv
    #. Mover todos os arquivos ***.csv** para o diretório **/opt/openerp/orizon** do servidor **tkl-odoo08-biobox-aws**.

#. :red:`(Não Executado)` [tkl-odoo08-biobox-aws] Conetar-se ao servidor **tkl-odoo08-biobox-aws** (as root):
...
#. [tkl-odoo08-biobox-aws] Processar os dados de **Dispensations (Ext)** (**clvhealth_biobox_pro_01**):
    ...
    --> clv_medicament_dispensation_ext.py - Execution time: **indisponível**
...
#. [tkl-odoo08-biobox-aws] Criar um backup dos dados de "**clvhealth_biobox_pro_01**" ("**bb-aws-postgres-01**") no servidor "**tkl-odoo08-biobox-aws**", executando (as openerp):
    ...
    ::
        ...
        pg_dump clvhealth_biobox_pro_01 -Fp -U postgres -h 172.31.38.203 -p 5432 > clvhealth_biobox_pro_01_2019-09-25a.sql
        gzip clvhealth_biobox_pro_01_2019-09-25a.sql

        exit

    Criados o seguinte arquivo:
        * /opt/openerp/clvhealth_biobox_pro_01_2019-09-25a.sql.gz
...
#. :red:`(Não Executado)` [bb-aws-web2py-odoo-01] Manutenção preventiva do servidor **bb-aws-web2py-odoo-01**:
    ...
    ::
        ...
        ls -al
        rm OE-Source-20190701-0100.tar.gz
        rm clvhealth_biobox_pro_01-20190701-0100.dump
        ls -al
