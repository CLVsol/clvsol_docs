...
#. [tkl-odoo12-dev-vm] **Atualizar** os módulos:
    ...
    * clv_person_sync_jcafb
    ...
    ::
        ...
        python install.py --admin_pw "***" --admin_user_pw "***" --data_admin_user_pw "***" --dbname "clvhealth_jcafb" -m clv_global_tag_sync_jcafb clv_address_sync_jcafb clv_person_sync_jcafb
