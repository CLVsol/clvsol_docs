...
#. [tkl-odoo12-dev-vm] Criar um backup dos dados de "**clvhealth_jcafb**", executando:
    ...
    ::
        ...
        cd /opt/odoo
        pg_dump clvhealth_jcafb -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2019-04-13a.sql

        gzip clvhealth_jcafb_2019-04-13a.sql
        pg_dump clvhealth_jcafb -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2019-04-13a.sql

        cd /var/lib/odoo/.local/share/Odoo/filestore
        tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2019-04-13a.tar.gz clvhealth_jcafb

        cd /opt/odoo/clvsol_filestore
        tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-04-13a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2019-04-13a.sql
        * /opt/odoo/clvhealth_jcafb_2019-04-13a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2019-04-13a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-04-13a.tar.gz
