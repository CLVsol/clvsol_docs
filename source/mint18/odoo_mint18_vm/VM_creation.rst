...
#. Create a new virtual machine using the following parameters as a reference::
	...
	Virtual machine name: "odoo-mint18"
	Processors: 4/2
	...
	Maximum disk size  20.0 GB, split vitual disk into multiple files
...
#. Mount a CD/DVD disk using the image "**linuxmint-18-cinnamon-64bit.iso**" and power on the virtual machine. Use the following parameters as a reference::
	...
	Who are you?
	    Your name: OpenERP
	    Your computer's name: odoo-mint18
	    Pick a username: openerp
	    Choose a password: OdooMint18$
	    Continue
