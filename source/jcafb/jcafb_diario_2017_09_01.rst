...
#. Criar um backup dos dados de "**clvhealth_jcafb_2018**", executando:
    ...
    ::
        ...
        cd /opt/openerp
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-09-01a.sql
        gzip clvhealth_jcafb_2018_2017-09-01a.sql
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-09-01a.sql

        cd /opt/openerp/.local/share/Odoo/filestore
        tar -czvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-09-01a.tar.gz clvhealth_jcafb_2018

    Criados os seguintes arquivos:
        * /opt/openerp/clvhealth_jcafb_2018_2017-09-01a.sql
        * /opt/openerp/clvhealth_jcafb_2018_2017-09-01a.sql.gz
        * /opt/openerp/filestore_clvhealth_jcafb_2018_2017-09-01a.tar.gz
...
#. Exportar os dados do **CLVhealth-JCAFB** (**JCAFB-2018**), executando:
    ...
    --> setup.py - Execution time: **0:21:59.125**

    Backup do arquivo exportado: **clvhealth_jcafb_2017_update_2017-09-01a.sqlite**
...
#. Criar uma nova instância do **CLVhealth-JCAFB** (**JCAFB-2018**):
    ...
    --> install.py - Execution time: **0:02:11.962**
...
#. Importar os dados do **CLVhealth-JCAFB** (**JCAFB-2017**):
    ...
    --> setup.py - Execution time: **0:14:58.819**
...
#. Restaurar o backup dos dados de "**clvhealth_jcafb_2018**" no servidor de testes, executando:
    ...
    ::
        ...
        cd /opt/openerp
        gzip -d clvhealth_jcafb_2018_2017-09-01a.sql.gz
        dropdb -i clvhealth_jcafb_2018
        createdb -O openerp -E UTF8 -T template0 clvhealth_jcafb_2018
        psql -f clvhealth_jcafb_2018_2017-09-01a.sql -d clvhealth_jcafb_2018 -U postgres -h localhost -p 5432 -q

        cd /opt/openerp/.local/share/Odoo/filestore
        rm -rf clvhealth_jcafb_2018
        tar -xzvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-09-01a.tar.gz
