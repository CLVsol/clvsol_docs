...
#. Criar um backup dos dados de "**clvhealth_jcafb_2018**", executando:
    ...
    ::
        ...
        cd /opt/openerp
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-11-09a.sql
        gzip clvhealth_jcafb_2018_2017-11-09a.sql
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-11-09a.sql

        cd /opt/openerp/.local/share/Odoo/filestore
        tar -czvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-11-09a.tar.gz clvhealth_jcafb_2018

    Criados os seguintes arquivos:
        * /opt/openerp/clvhealth_jcafb_2018_2017-11-09a.sql
        * /opt/openerp/clvhealth_jcafb_2018_2017-11-09a.sql.gz
        * /opt/openerp/filestore_clvhealth_jcafb_2018_2017-11-09a.tar.gz
