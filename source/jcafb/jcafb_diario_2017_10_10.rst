...
#. **Instalar / Atualizar** os módulos "**clv_off**", "**clv_person_off**", "**clv_person_off_l10n_br**", "**clv_person_off_jcafb**", "**clv_document_off**", **clv_document_off_jcafb**" e **clv_lab_test_off**":
    ...
    ::
        ...
        cd /opt/openerp/clvsol_clvhealth_jcafb/project
        python install.py --admin_pw "***" --admin_user_pw "***" --data_admin_user_pw "***" --dbname "clvhealth_jcafb_2018" -m clv_off
