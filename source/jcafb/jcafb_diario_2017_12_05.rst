...
#. Restaurar o backup dos dados de "**clvhealth_jcafb_2018**" no servidor **tkl-odoo10-jcafb-vm**, executando:
    ...
    ::
        ...
        psql -f clvhealth_jcafb_2018_2017-12-04a.sql -d clvhealth_jcafb_2018 -U postgres -h localhost -p 5432 -q

        cd /opt/openerp/.local/share/Odoo/filestore
        rm -rf clvhealth_jcafb_2018
        tar -xzvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-12-04a.tar.gz
...
#. Criar um backup dos dados de "**clvhealth_jcafb_2018**", executando:
    ...
    ::
        ...
        cd /opt/openerp
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-12-05a.sql

        gzip clvhealth_jcafb_2018_2017-12-05a.sql
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-12-05a.sql

        cd /opt/openerp/.local/share/Odoo/filestore
        tar -czvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-12-05a.tar.gz clvhealth_jcafb_2018

    Criados os seguintes arquivos:
        * /opt/openerp/clvhealth_jcafb_2018_2017-12-05a.sql
        * /opt/openerp/clvhealth_jcafb_2018_2017-12-05a.sql.gz
        * /opt/openerp/filestore_clvhealth_jcafb_2018_2017-12-05a.tar.gz
