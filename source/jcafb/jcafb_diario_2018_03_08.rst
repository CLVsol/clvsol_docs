...
#. [tkl-odoo10-jcafb-vm] Criar um backup dos dados de "**clvhealth_jcafb_2018**", executando:
    ...
    ::
        ...
        cd /opt/openerp
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2018-03-08a.sql

        gzip clvhealth_jcafb_2018_2018-03-08a.sql
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2018-03-08a.sql

        cd /opt/openerp/.local/share/Odoo/filestore
        tar -czvf /opt/openerp/filestore_clvhealth_jcafb_2018_2018-03-08a.tar.gz clvhealth_jcafb_2018

        cd /opt/openerp/clvsol_clvhealth_jcafb
        tar -czvf /opt/openerp/data_export_files_2018_2018-03-08a.tar.gz data_export_files

        cd /opt/openerp/clvsol_clvhealth_jcafb/lab_test_files/reports
        tar -czvf /opt/openerp/lab_test_report_templates_2018_2018-03-08a.tar.gz templates

        cd /opt/openerp/clvsol_clvhealth_jcafb/lab_test_files/reports
        tar -czvf /opt/openerp/lab_test_report_xls_2018_2018-03-08a.tar.gz xls

        cd /opt/openerp/clvsol_clvhealth_jcafb/lab_test_files/results
        tar -czvf /opt/openerp/lab_test_result_templates_2018_2018-03-08a.tar.gz templates

        cd /opt/openerp/clvsol_clvhealth_jcafb/lab_test_files/results
        tar -czvf /opt/openerp/lab_test_result_xls_2018_2018-03-08a.tar.gz xls

        cd /opt/openerp/clvsol_clvhealth_jcafb
        tar -czvf /opt/openerp/report_files_2018_2018-03-08a.tar.gz report_files

        cd /opt/openerp/clvsol_clvhealth_jcafb
        tar -czvf /opt/openerp/summary_files_2018_2018-03-08a.tar.gz summary_files

        cd /opt/openerp/clvsol_clvhealth_jcafb/survey_files
        tar -czvf /opt/openerp/survey_files_archive_2018_2018-03-08a.tar.gz archive

        cd /opt/openerp/clvsol_clvhealth_jcafb/survey_files
        tar -czvf /opt/openerp/survey_files_input_2018_2018-03-08a.tar.gz input

        cd /opt/openerp/clvsol_clvhealth_jcafb/survey_files
        tar -czvf /opt/openerp/survey_files_templates_2018_2018-03-08a.tar.gz templates
    ...
    Criados os seguintes arquivos:
        * /opt/openerp/clvhealth_jcafb_2018_2018-03-08a.sql
        * /opt/openerp/clvhealth_jcafb_2018_2018-03-08a.sql.gz
        * /opt/openerp/filestore_clvhealth_jcafb_2018_2018-03-08a.tar.gz
        * /opt/openerp/data_export_files_2018_2018-03-08a.tar.gz
        * /opt/openerp/lab_test_report_templates_2018_2018-03-08a.tar.gz
        * /opt/openerp/lab_test_report_xls_2018_2018-03-08a.tar.gz
        * /opt/openerp/lab_test_result_templates_2018_2018-03-08a.tar.gz
        * /opt/openerp/lab_test_result_xls_2018_2018-03-08a.tar.gz
        * /opt/openerp/report_files_2018_2018-03-08a.tar.gz
        * /opt/openerp/summary_files_2018_2018-03-08a.tar.gz
        * /opt/openerp/survey_files_archive_2018_2018-03-08a.tar.gz
        * /opt/openerp/survey_files_input_2018_2018-03-08a.tar.gz
        * /opt/openerp/survey_files_templates_2018_2018-03-08a.tar.gz
