...
#. Restaurar o backup dos dados de "**clvhealth_jcafb_2018**" no servidor **tkl-odoo10-jcafb-vm**, executando:
    ...
    ::
        ...
        psql -f clvhealth_jcafb_2018_2017-11-09a.sql -d clvhealth_jcafb_2018 -U postgres -h localhost -p 5432 -q

        cd /opt/openerp/.local/share/Odoo/filestore
        rm -rf clvhealth_jcafb_2018
        tar -xzvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-11-09a.tar.gz
...
#. Criar um backup dos dados de "**clvhealth_jcafb_2018**", executando:
    ...
    ::
        ...
        cd /opt/openerp
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-11-13a.sql
        gzip clvhealth_jcafb_2018_2017-11-13a.sql
        pg_dump clvhealth_jcafb_2018 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2018_2017-11-13a.sql

        cd /opt/openerp/.local/share/Odoo/filestore
        tar -czvf /opt/openerp/filestore_clvhealth_jcafb_2018_2017-11-13a.tar.gz clvhealth_jcafb_2018

    Criados os seguintes arquivos:
        * /opt/openerp/clvhealth_jcafb_2018_2017-11-13a.sql
        * /opt/openerp/clvhealth_jcafb_2018_2017-11-13a.sql.gz
        * /opt/openerp/filestore_clvhealth_jcafb_2018_2017-11-13a.tar.gz
...
#. Restaurar o backup dos dados de "**clvhealth_jcafb_2018**" no servidor **clvheatlh-jcafb-2018-aws-tst**, executando:
    ...
    ::
        ...
        cd /opt/openerp
        gzip -d clvhealth_jcafb_2018_2017-11-13a.sql.gz
        dropdb -i clvhealth_jcafb_2018
        createdb -O openerp -E UTF8 -T template0 clvhealth_jcafb_2018
